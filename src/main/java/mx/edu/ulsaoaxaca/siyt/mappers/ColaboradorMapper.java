...
public interface ColaboradorMapper {
	 ...
	 * ) public void update(@Param("usuario") String usuario, @Param("contrasena")
	 * String contrasena,
	 * 
	 * @Param("nombre") String nombre, @Param("apellido1") String
	 * apellido1, @Param("apellido2") String apellido2,
	 * 
